...
if __name__ == '__main__':
    ...
    # Create a dict with the column "country" and "country_code"
    country_code_dict = create_dict(
        phone_code_df, "country", "country_code")

    # Label the country of the phone number
    users_data = label_countries(users_data, country_code_dict)
...
def load_cloudburst_user_members_data() -> pd.DataFrame:
    """
    This function loads the data from cloudburst and preprocess a bit
    ...
    Return the retrieved and preprocessed data as pandas dataframe
    """
    tbl_users = load_cloudburst_users_data()
    tbl_members = load_cloudburst_members_data()
    tbl_users_members = tbl_users.merge(tbl_members, left_on="pid", right_on="user_PID")
    return tbl_users_members

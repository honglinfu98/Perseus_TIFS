...
from perseus.dataset.preprocess.process import aggregate_data, assign_event_ids, get_graphs, process_dataframe
...
def combine_and_plot_graphs(graph_dict, layout='spring', figsize=(12, 12), edge_alpha=0.5, edge_width=0.5):
    ...
    nx.draw(combined_graph, pos, with_labels=True, node_size=5000, node_color='red', edge_color='blue',
            width=edge_width, alpha=edge_alpha, font_size=10, font_weight='bold')
...
if __name__ == "__main__":
    ...
    combine_and_plot_graphs(gs, layout='kamada_kawai', figsize=(100, 100), edge_alpha=1, edge_width=1.5)

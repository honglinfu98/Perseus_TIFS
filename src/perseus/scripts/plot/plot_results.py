...
# Plotting Precision and F1 scores separately
for i, dataset in enumerate(datasets):
    for j, model in enumerate(models):
        labels = results_t[dataset][model]["metrics"]["labels"]
        probs = results_t[dataset][model]["metrics"]["probs"]
...
axs[0].set_title("Precision Across Datasets and Models")
axs[0].set_ylabel("Precision")
axs[0].legend(loc="best", fontsize="small")

axs[1].set_title("F1 Score Across Datasets and Models")
...
# To enhance readability, let's simplify the plot with fewer models, adjust linewidths, and modify the legend

fig, axs = plt.subplots(2, 1, figsize=(12, 12), sharex=True)

# Simplifying the plot by selecting a subset of models from each dataset
selected_models = ["GraphSAGE", "GAT"]
...
for i, dataset in enumerate(datasets):
    for model in selected_models:
        ...
        axs[0].plot(
            thresholds,
            precision_scores,
            linestyle=linestyles[selected_models.index(model)],
            color=colors[i],
            label=f"{dataset} {model} Precision",
            linewidth=2,
        )
...
axs[0].set_title("Precision Across Selected Models")
axs[0].set_ylabel("Precision")
axs[0].legend(loc="upper right", fontsize="small")

axs[1].set_title("F1 Score Across Selected Models")
axs[1].set_xlabel("Threshold")
axs[1].set_ylabel("F1 Score")

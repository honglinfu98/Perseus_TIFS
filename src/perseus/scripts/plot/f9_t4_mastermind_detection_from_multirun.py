...
def run_detection(get_signals_func, save_path=None):
    """
    Run detection pipeline using a provided function to get signals.
    Returns key intermediate and final variables, and saves combined detection if save_path is given.
    """
    ...
    # Load model and threshold as before
    ...
    for asset, nodes in all_predictions.items():
        ...
        for node_id, pred in nodes.items():
            ...
            combined_predictions[asset][node_id] = (pred, label)
